                    ...
                    <table class="table table-striped">
                        ...
                        <tbody>
                            ...
                            <tr>
                                <td>{{ $no++ }}</td>
                                <td>
                                    <img src="{{ url('uploads') }}/{{ $pesanan_detail->katalogs->gambar }}" width="100" alt="...">
                                </td>
                                <td>{{ $pesanan_detail->katalogs->nama_katalogs }}</td>
                                <td>{{ $pesanan_detail->jumlah }} kain</td>
                                <td align="right">Rp. {{ number_format($pesanan_detail->katalogs->harga) }}</td>
